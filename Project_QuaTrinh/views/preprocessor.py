...
def preprocessor_view():
    ...
    tab1, tab2 = st.tabs(["Tiền xử lý", "Hướng dẫn "])
    with tab1:
    ...
    with tab2:
        st.markdown(
            ...
            - **Chọn các phương thức tiền xử lý**: Chọn các tùy chọn tiền xử lý từ danh sách.
            - **Biểu đồ (NER)**: Hiển thị biểu đồ nhận diện thực thể.
            - **Thực hiện**: Nhấn nút để thực hiện tiền xử lý dữ liệu.
            - **Kết quả**: Kết quả sẽ hiển thị ở bên dưới.
            - **Tải xuống**: Bạn có thể tải xuống kết quả xử lý bằng cách nhấn nút "Tải xuống".
            ---
            """
        )
